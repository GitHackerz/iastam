            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
                <span className="font-semibold">
                  The IASTAM 5.0 Startup Technical Challenge
                </span>{" "}
                is a two-month
                program empowering innovators to turn ideas into startups. It
                takes teams from ideation to MVP. The challenge ends with a
                pitch to investors and incubators.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                    <span className="text-primary font-bold">5th</span>
                  </div>
                  <span>
                    Edition of
                    <br />
